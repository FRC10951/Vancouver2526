...
public final class Constants {
  ...
  public static final class IoConstants {
    ...
    /** Wait 1 second for the shooter to spin super fast before throwing the ball into it. */
    public static final double LAUNCH_SPIN_UP_SECONDS = 1.0;
    
    /** How long to wait for the shooter to spin up when eating balls (0 means don't wait). */
    public static final double INTAKE_SPIN_UP_SECONDS = 0;
    
    /** How long to wait for the shooter to spin up during the robot's self-driving mode. */
   ...
   * The robot has to know how far to drive and how fast to go without a human driver.
   */
  ...
  /**
   * Prints out a nice, neat list of all our motor ID numbers so we can double-check them!
   */
